...
The project PHP in browser \squarecite{2} enables running PHP script inside your browser using predefined Javascript API or standard tag for script in HTML.
...
The consequence of WASM is an introduction of Blazor \squarecite{3}.
...
Another interesting technology connecting .NET and PHP world is Peachpie \squarecite{4}.

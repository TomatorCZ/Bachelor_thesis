...
A part of the support code is a Javascript, which is linked to at the beginning of \texttt{index.html}, providing helper functions for form handling and interoperability with PHP.  
...
Additionally, the called C\# method has to be marked with a \texttt{JSCallableAttribute} during compilation.

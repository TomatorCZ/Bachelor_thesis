...
PHP \squarecite{5} is interpreted language maintained by The PHP Group.
...
An unusual thing is superglobals \squarecite{6}, which are built-in variables accessible from all scopes of the script.
...
Threads \squarecite{10} support is currently discussed nowadays and appears to be realistic.
...
A replacement of multi-threading can be web workers \squarecite{11}.

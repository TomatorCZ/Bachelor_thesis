...
1. Introduction 
   ...
   - Short introduction into web application, give a high level overview of the problem (PHP Blazor interop, PHP client side)
...
2. Existing technologies
   ...
   3. Blazor
      ...
      - Describe how Blazor WebAssembly client serves the pages (Components, Razor, Router,  Navigation, Process of rendering, RenderTreeBuilder, Diff algorithm,..)
   4. PeachPie
      - Explain what it is
...
3. Problem analysis
   ...
   - Changing paradigm of PHP (Persistent vs. changing context)
...
6. Experiments
   ...
   - Compare my solution and [pib](https://github.com/oraoto/pib?fbclid=IwAR3KZKXWCC3tlgQf886PF3GT_Hc8pmfCMI1-43gdQEdE5wYgpv070bRwXqI) 

...
We will introduce the Common Language Infrastructure (abbreviated CLI) \cite{online:cliWiki} before diving into .NET, which is an overused name for several technologies.

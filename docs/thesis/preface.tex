...
\ac{WASM} was developed to offer a portable binary-code format for executing programs inside a browser \squarecite{1} in 2015.
...
For example, the project PHP in browser \squarecite{2} enables running a PHP script inside our browser using predefined Javascript API or standard HTML tag.
...
Peachpie \squarecite{4} compiles PHP to .NET and enables interoperability between the languages.

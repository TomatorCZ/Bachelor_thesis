...
class Application extends \PhpBlazor\Tag 
{
    ...
    public function __construct(array $settings) 
    {
        ...
        $this->attributes["onkeydown"] = "(e) => window.php.callPHP('HandleKeyDown', e);";
        $this->attributes["onkeyup"] = "window.php.callPHP('HandleKeyUp');";
    ...
    public function addButtons() : void
    {
        ...
        $button->attributes["onmousedown"] = "window.php.callPHP('HandleMouseDownMoveRight');";
        $button->attributes["onmouseup"] = "window.php.callPHP('HandleMouseUp');";
        ...
        $button->attributes["onmousedown"] = "window.php.callPHP('HandleFire');";
        ...
        $button->attributes["onmousedown"] = "window.php.callPHP('HandleMouseDownMoveLeft');";
        $button->attributes["onmouseup"] = "window.php.callPHP('HandleMouseUp');";
    ...
    public function HandleKeyDown($e) : void
    {
        if ($e->Key === "ArrowLeft")
        {
    ...
    public function HandleMouseDownMoveRight() : void
    {
         $this->rocket->changeDirection(["x" => 2,"y" => 0]);
    }
    ...
    public function HandleMouseDownMoveLeft() : void
    {
         $this->rocket->changeDirection(["x" => -2,"y" => 0]);
    }
